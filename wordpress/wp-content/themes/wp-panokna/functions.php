...
function wpeSideNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<div class="options_banners asside-box">%3$s</div>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
// WPE sidebar navigation
function wpeSideSecondNav() {
  wp_nav_menu(
  array(
    'theme_location'  => 'sidebar-second-menu',
    'menu'            => '',
    'container'       => 'div',
    'container_class' => 'menu-{menu slug}-container',
    'container_id'    => '',
...
function register_html5_menu() {
  register_nav_menus(array(
    ...
    'sidebar-second-menu' => __('Меню категорий', 'wpeasy'),
